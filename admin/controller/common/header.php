...
class ControllerCommonHeader extends Controller {
	protected function index() {
		...
		/* Tracking Module */
		$this->data['text_report_payment_transfer'] = $this->language->get('text_report_payment_transfer');
		/* Tracking Module */
		...
		if (!$this->user->isLogged() || !isset($this->request->get['token']) || !isset($this->session->data['token']) || ($this->request->get['token'] != $this->session->data['token'])) {
			...
			/* Tracking Module */
			$this->data['report_payment_transfer'] = $this->url->link('report/payment_transfer', 'token=' . $this->session->data['token'], 'SSL');
			/* Tracking Module */
